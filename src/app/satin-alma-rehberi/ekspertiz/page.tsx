  ...
  return (
    <>
      ...
      <section className="container-x pb-12 pt-16 sm:pt-24 relative overflow-hidden">
        ...
        />
        <SectionHeading
          eyebrow="İkinci El XMAX Ekspertiz Rehberi"
          title={
            <>
              50 Maddelik
              <br />
              <span className="text-electric">Ekspertiz Protokolü</span>
            </>
          }
          description="Aracı görmeye gitmeden önce, satıcının yanındayken ve kapora vermeden önce yapılacak tam teknik kontrol. Mühendislik verileri, kronik arıza haritası, jenerasyon karşılaştırması ve Türkiye'ye özel mali analiz bir arada."
        />
      </section>
